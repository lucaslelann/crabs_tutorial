# Upload the data
In this section you upload the crabs dataset to your teams project.

__Tercen__ accepts data in either _.tsv_ or _csv_. The example data set `crabs_long.csv` is in a _.csv_ format and is in a _long format_. 
...
(https://raw.githubusercontent.com/tercen/crabs_dataset/master/data/crabs_long.csv)
...
> Better to say right click link and then save as. The data downloads as cradb_long.csv. No renaming and differant default name. 
...
Navigate to your crabs projects homepage. 
...
<center><img src="images/View_add_dataset.png"></center>
...
<center><img src="images/View_data_table.png"></center>
...
<center><img src="images/View_data_added.png"></center>
