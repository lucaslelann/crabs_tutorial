...
> See chapter 16 (File 21) for same text?
...
> Label zone concept is introduced here. Should we explain what it isi for.
...
> Instruction to drag the new data step out.

The workflow should look like the image below

> The Gather and Pairwise PCA have not been don at this point in the turorial. New screen shot needed?
