...
The box that had just appeared in the workflow is called a __step__ 

Steps are the fundamental building blocks of your data analysis process.

By right clicking a step the long menu appears.

This allows you to perform actions on a step.
...
__Edit__|Takes you to the projection page of the step.
...
__Add__| Add a new step which will use the outputs from this step.
