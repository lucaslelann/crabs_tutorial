...
A Gather is a function to select and match sections of data from multiple sources. 

The selections are combined to form a new data set for following calculations.
