...
By putting the same factor (i.e. ``variable``) on the row and column zone.

This view is a powerful tool for data visualization.
...
Drag and drop these factors into the empty grid
...
__Next__ make the results of a computation exportable.
