...
Drag and Drop factors to the tab name to configure how data is represented on the visualisation.
...
Zone|Description
------|---
__Label__ |Additional description or seperation applied to a factor.
